...
$CargoTomls = @(
    ...
    "rust/crates/mcp-server/Cargo.toml"
)
...
if ($Commit) {
    git add VERSION.txt rust/crates/main/Cargo.toml rust/crates/hot-reload/Cargo.toml rust/crates/mcp-server/Cargo.toml Cargo.lock
